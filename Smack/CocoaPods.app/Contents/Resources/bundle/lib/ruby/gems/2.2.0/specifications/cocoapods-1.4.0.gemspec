...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      s.add_runtime_dependency(%q<cocoapods-core>.freeze, ["= 1.4.0"])
      s.add_runtime_dependency(%q<claide>.freeze, ["< 2.0", ">= 1.0.2"])
      s.add_runtime_dependency(%q<cocoapods-deintegrate>.freeze, ["< 2.0", ">= 1.0.2"])
      s.add_runtime_dependency(%q<cocoapods-downloader>.freeze, ["< 2.0", ">= 1.1.3"])
      ...
      s.add_runtime_dependency(%q<molinillo>.freeze, ["~> 0.6.4"])
      s.add_runtime_dependency(%q<xcodeproj>.freeze, ["< 2.0", ">= 1.5.4"])
      ...
      s.add_dependency(%q<cocoapods-core>.freeze, ["= 1.4.0"])
      s.add_dependency(%q<claide>.freeze, ["< 2.0", ">= 1.0.2"])
      s.add_dependency(%q<cocoapods-deintegrate>.freeze, ["< 2.0", ">= 1.0.2"])
      s.add_dependency(%q<cocoapods-downloader>.freeze, ["< 2.0", ">= 1.1.3"])
      ...
      s.add_dependency(%q<molinillo>.freeze, ["~> 0.6.4"])
      s.add_dependency(%q<xcodeproj>.freeze, ["< 2.0", ">= 1.5.4"])
